...
from mcp.client.auth import OAuthClientProvider as _MCPOAuthClientProvider, TokenStorage
from mcp.shared.auth import OAuthClientInformationFull, OAuthMetadata as _MCPServerOAuthMetadata, OAuthToken as OAuthToken
...
async def discover_oauth_metadata(server_base_url: str, httpx_kwargs: dict[str, Any] | None = ...) -> _MCPServerOAuthMetadata | None:
    """
...
def OAuth(mcp_url: str, scopes: str | list[str] | None = ..., client_name: str = ..., token_storage_cache_dir: Path | None = ..., additional_client_metadata: dict[str, Any] | None = ...) -> _MCPOAuthClientProvider:
    """
