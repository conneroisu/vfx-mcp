...
class FastMCP(Generic[LifespanResultT]):
    ...
    async def run_async(self, transport: Transport | None = ..., **transport_kwargs: Any) -> None:
    ...
    def run(self, transport: Transport | None = ..., **transport_kwargs: Any) -> None:
    ...
    @overload
    def tool(self, name_or_fn: AnyFunction, *, name: str | None = ..., description: str | None = ..., tags: set[str] | None = ..., annotations: ToolAnnotations | dict[str, Any] | None = ..., exclude_args: list[str] | None = ..., enabled: bool | None = ...) -> FunctionTool:
        ...
    
    @overload
    def tool(self, name_or_fn: str | None = ..., *, name: str | None = ..., description: str | None = ..., tags: set[str] | None = ..., annotations: ToolAnnotations | dict[str, Any] | None = ..., exclude_args: list[str] | None = ..., enabled: bool | None = ...) -> Callable[[AnyFunction], FunctionTool]:
        ...
    
    def tool(self, name_or_fn: str | AnyFunction | None = ..., *, name: str | None = ..., description: str | None = ..., tags: set[str] | None = ..., annotations: ToolAnnotations | dict[str, Any] | None = ..., exclude_args: list[str] | None = ..., enabled: bool | None = ...) -> Callable[[AnyFunction], FunctionTool] | FunctionTool:
    ...
    def resource(self, uri: str, *, name: str | None = ..., description: str | None = ..., mime_type: str | None = ..., tags: set[str] | None = ..., enabled: bool | None = ...) -> Callable[[AnyFunction], Resource | ResourceTemplate]:
    ...
    @overload
    def prompt(self, name_or_fn: AnyFunction, *, name: str | None = ..., description: str | None = ..., tags: set[str] | None = ..., enabled: bool | None = ...) -> FunctionPrompt:
        ...
    
    @overload
    def prompt(self, name_or_fn: str | None = ..., *, name: str | None = ..., description: str | None = ..., tags: set[str] | None = ..., enabled: bool | None = ...) -> Callable[[AnyFunction], FunctionPrompt]:
        ...
    
    def prompt(self, name_or_fn: str | AnyFunction | None = ..., *, name: str | None = ..., description: str | None = ..., tags: set[str] | None = ..., enabled: bool | None = ...) -> Callable[[AnyFunction], FunctionPrompt] | FunctionPrompt:
    ...
    async def run_http_async(self, transport: Literal["http", "streamable-http", "sse"] = ..., host: str | None = ..., port: int | None = ..., log_level: str | None = ..., path: str | None = ..., uvicorn_config: dict[str, Any] | None = ..., middleware: list[ASGIMiddleware] | None = ...) -> None:
