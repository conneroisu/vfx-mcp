...
class Middleware:
    ...
    async def on_list_tools(self, context: MiddlewareContext[mt.ListToolsRequest], call_next: CallNext[mt.ListToolsRequest, ListToolsResult]) -> ListToolsResult:
        ...
    
    async def on_list_resources(self, context: MiddlewareContext[mt.ListResourcesRequest], call_next: CallNext[mt.ListResourcesRequest, ListResourcesResult]) -> ListResourcesResult:
        ...
    
    async def on_list_resource_templates(self, context: MiddlewareContext[mt.ListResourceTemplatesRequest], call_next: CallNext[mt.ListResourceTemplatesRequest, ListResourceTemplatesResult]) -> ListResourceTemplatesResult:
        ...
    
    async def on_list_prompts(self, context: MiddlewareContext[mt.ListPromptsRequest], call_next: CallNext[mt.ListPromptsRequest, ListPromptsResult]) -> ListPromptsResult:
        ...
