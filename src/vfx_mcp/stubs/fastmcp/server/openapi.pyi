...
class OpenAPITool(Tool):
    ...
    def __init__(self, client: httpx.AsyncClient, route: openapi.HTTPRoute, name: str, description: str, parameters: dict[str, Any], tags: set[str] | None = ..., timeout: float | None = ..., annotations: ToolAnnotations | None = ..., serializer: Callable[[Any], str] | None = ...) -> None:
        ...
