...
from mcp.types import Annotations, AudioContent, EmbeddedResource, ImageContent, TextContent
...
class Image:
    ...
    def to_image_content(self, mime_type: str | None = ..., annotations: Annotations | None = ...) -> ImageContent:
...
class Audio:
    ...
    def to_audio_content(self, mime_type: str | None = ..., annotations: Annotations | None = ...) -> AudioContent:
        ...
...
class File:
    ...
    def to_resource_content(self, mime_type: str | None = ..., annotations: Annotations | None = ...) -> EmbeddedResource:
        ...
